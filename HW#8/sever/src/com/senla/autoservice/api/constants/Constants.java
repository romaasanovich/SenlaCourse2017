...
public class Constants {
	...
	public static final String PATH_TO_MASTERS = "..\\res\\Masters.txt";
	public static final String PATH_TO_PLACES = "..\\res\\Places.txt";
	public static final String ERROR_WRONG_INPUT = "Error.Wrong input!!";
	public static final String PATH_TO_PROP = "..\\res\\Prop.txt";
	public static final String ERROR_FILE_NOT_FOUND = "Error.File not found !!!";
	public static final String LOG_PATH = "..\\res\\Log.txt";
	...
	public static final Integer SERVER_PORT = 3375;
