...
class Builder {
	...
	Map<MenuType, Menu> buildMenu() {
		...
		placeMenuInit(placeMenu);
		response.put(MenuType.Place, placeMenu);

		masterMenuInit(masterMenu, masterSortMenu);
		response.put(MenuType.Master, masterMenu);

		orderMenuInit(orderMenu, orderSortMenu, curOrderSortMenu, orderStatusMenu);
		response.put(MenuType.Order, orderMenu);

		return response;
	}

	private void orderMenuInit(final Menu orderMenu, final Menu orderSortMenu,
	...
	private void masterMenuInit(final Menu masterMenu, final Menu masterSortMenu) {
	...
	private void placeMenuInit(final Menu placeMenu) {
