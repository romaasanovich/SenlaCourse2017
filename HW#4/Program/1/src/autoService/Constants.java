...
public class Constants {
	...
	public static final String PATH_TO_MASTERS = "data\\masters.txt";
	public static final String PATH_TO_WORKS="data\\works.txt";
	public static final String PATH_TO_PLACES="data\\places.txt";
}
