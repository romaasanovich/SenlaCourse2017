...
public class Constants {
	...
	public static final String PATH_TO_MASTERS = "files/Masters.txt";
	public static final String PATH_TO_WORKS="files/Works.txt";
	public static final String PATH_TO_PLACES="files/Places.txt";
}
