...
public class Constants {
	...
	public static final String PATH_TO_MASTERS = "Masters.txt";
	public static final String PATH_TO_WORKS = "Works.txt";
	public static final String PATH_TO_PLACES = "Places.txt";
}
